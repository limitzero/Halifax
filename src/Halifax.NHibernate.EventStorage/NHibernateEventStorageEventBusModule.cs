...
{
    public class NHibernateEventStorageEventBusModule :
        AbstractEventBusModule
    {
        private readonly ISessionFactory _factory;

        [ThreadStatic]
        private static IEventStorageSession _currentsession;

        public NHibernateEventStorageEventBusModule(ISessionFactory factory)
        {
            _factory = factory;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public IEventStorageSession GetCurrentSession()
        {
            CreateSession();
        ...
        {
            _currentsession = new EventStorageSession {Session = _factory.OpenSession()};
        }
    }
}