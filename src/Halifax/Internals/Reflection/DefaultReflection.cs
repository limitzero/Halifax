...
namespace Halifax.Internals.Reflection
{
    public class DefaultReflection : IReflection
    {
        ...
        public void InvokeExecuteMethodForCommandConsumer<TCOMMAND>(IUnitOfWork session, TCOMMAND command) 
        ...
        public void InvokeExecuteMethodForCommandConsumer(IUnitOfWork session, Command command)
        {
            Type theType = typeof (CommandConsumer.For<>).MakeGenericType(command.GetType());
            Array theHandlers;
            object theHandler;
